...
export const CourseRejectionEmail = ({ teacherName, courseTitle, reason }: CourseRejectionEmailProps) => {
  return (
    <Html>
      <Preview>Course Review Update</Preview>
      <Tailwind config={{
          theme: {
            extend: {
              colors: { 
        ...
        <Body className="bg-surface text-onSurface font-body m-0 p-0 antialiased py-8">
          <Container className="max-w-[600px] mx-auto p-4 md:p-6">
            ...
            <main className="px-2">
              ...
              <Section className="p-8 rounded-xl mb-8 border border-amber-200 bg-amber-50/30 shadow-sm relative overflow-hidden">
                <Text className="text-2xl font-bold font-headline mb-4 text-[#0f172a]">Course Review Needs Attention</Text>
                <Text className="text-[16px] font-body text-onSurfaceVariant leading-relaxed mb-6">
                  Hi {teacherName}, our team reviewed <strong>"{courseTitle}"</strong>. We noticed a few areas that need enhancement before we can publish it.
                </Text>
                
                <Section className="bg-amber-100 border-l-4 border-amber-600 p-6 mb-6 rounded-r-xl">
                  <Text className="m-0 text-amber-900 font-body text-[15px]"><strong>QA Feedback:</strong><br/><br/>{reason}</Text>
                </Section>
                
                <Text className="text-[15px] font-body text-onSurfaceVariant leading-relaxed mb-0">
                  Update the requested materials and re-submit. Our team is eager to review your revisions!
                </Text>
              </Section>
            </main>
