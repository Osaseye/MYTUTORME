...
interface CancelledEmailProps { name: string; }

export const SubscriptionCancelledEmail = ({ name }: CancelledEmailProps) => {
  return (
    <Html>
        ...
        <Body className="bg-surface text-onSurface font-body m-0 p-0 antialiased py-8">
          <Container className="max-w-[600px] mx-auto p-4 md:p-6">
            ...
            <main className="px-2">
              ...
              <Section className="bg-slate-100 p-10 rounded-[24px] mb-8 border border-slate-200 text-center">
                <Text className="text-2xl font-bold font-headline mb-4 text-[#0f172a]">Subscription Cancelled</Text>
                <Text className="text-[16px] font-body text-slate-600 leading-relaxed mb-6">
                  Hi {name}, we're confirming that your premium access to MyTutorMe will end at the conclusion of your current billing cycle.
                </Text>
                <Text className="text-[16px] font-body text-slate-600 leading-relaxed mb-8">
                  We're sorry to see you go! All your progress and data will be safely stored if you ever decide to jump back in.
                </Text>
                <Button className="inline-flex px-8 py-3 bg-white text-primary border-2 border-primary font-bold rounded-xl" href="https://mytutorme.org/pricing">
                  Reactivate Plan
                </Button>
              </Section>
            </main>
