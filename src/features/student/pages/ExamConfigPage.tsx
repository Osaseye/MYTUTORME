            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-slate-200 dark:border-slate-800">
                    ...
                    <div className="text-center py-8 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-dashed border-slate-200 dark:border-slate-700">
                        ...
                        <h3 className="font-bold text-slate-600 dark:text-slate-300">No Subjects Available</h3>
                        <p className="text-sm text-slate-500 mt-1">Enroll in a course to unlock subjects.</p>
                    </div>
                </div>
