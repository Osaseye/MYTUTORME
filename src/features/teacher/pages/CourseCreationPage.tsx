            ...
            <div className="bg-white dark:bg-surface-dark rounded-2xl p-6 border border-slate-200 dark:border-slate-700 shadow-sm">
              ...
              <div className="border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden mb-6">
                <div className="p-12 text-center text-slate-500 flex flex-col items-center justify-center">
                   <span className="material-icons-round text-4xl mb-4 text-slate-300">note_add</span>
                   <p className="font-medium text-slate-600 dark:text-slate-400 mb-2">Your curriculum is empty</p>
                   <p className="text-sm">Start by adding a section and creating lectures, quizzes, and assignments.</p>
                </div>
              </div>
            </div>
