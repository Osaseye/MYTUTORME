  ...
  useEffect(() => {
    ...
    const loadExam = async () => {
      ...
      try {
        ...
        // No paused attempt logic for unauthenticated users, just run timeout.
        ...
        let loadedQuestions = qSnaps.map(snap => ({ id: snap.id, ...snap.data() }));

        // PREVIEW MODE: Constrain to max 5 questions
            ...
            <div className="lg:col-span-6 order-1 lg:order-2">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-lg border border-slate-200 dark:border-slate-800 h-full flex flex-col relative overflow-hidden">
                    ...
                    <div className="p-4 md:p-8 pb-6">
                          ...
                          <h2 className="text-xl md:text-2xl flex flex-col font-bold font-display leading-tight text-slate-900 dark:text-white mb-2 prose dark:prose-invert">
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <span className={`block text-lg font-medium transition-colors ${valueClass} prose dark:prose-invert max-w-none`}>

                                            <ReactMarkdown>{optionText}</ReactMarkdown>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-8 max-w-md w-full shadow-2xl border border-slate-200 dark:border-slate-800 animate-in fade-in zoom-in duration-200">
               ...
               <div className="flex flex-col items-center text-center">
                  ...
                  <Button 
                     ...
                     className="mt-4 w-full text-slate-500 hover:text-slate-700 dark:hover:text-slate-300"
